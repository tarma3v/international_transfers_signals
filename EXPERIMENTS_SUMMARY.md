...
- Если следующий эффективный курс ЦБ уже опубликован, отдельная политика даёт
  **lift 1.959**. Это другой момент принятия решения, не обычный прогноз.
...
| После публикации курса | Known-next-rate | **1.959** | отдельный timestamp-aware продукт |
...
Самый большой абсолютный boost до 1.959 появился не из новой архитектуры, а из
изменения доступной информации: после публикации следующий эффективный курс уже
известен. Политика допустима только при runtime-проверке факта публикации.
...
`results/research/round3/`. Ничего из них не выброшено.

## Проверки

- 49 исходных тестов прошли.
- Ещё 2 теста проверяют причинность delayed features и момент обновления Online
  Hedge.
- PDF визуально проверен на всех 16 страницах.

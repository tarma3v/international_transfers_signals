...
Навигатор обновлён 06.09.2026; последний модельный прогон — 05.09.2026.
Для внутренней оптимизации сохраняется
`h=5`, официальный scorecard теперь считается сразу на `h=1/3/5/10/20`.

## Новый раунд: прямые биржевые пары и виджет (round 7)
...
Продолжение исследования: `research/round7_next_steps.md`, ежечасная задача.

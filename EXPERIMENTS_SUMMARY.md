...
## T3-T12: непрерывная температура и честное раннее обновление

Презентация из основной ветки формулирует продукт как экранный индикатор плюс
отдельное редкое уведомление. T12 причинно объединил фазовые модели в один
...
`push_now`. Ретроспективный пакет содержит **48 585** уникальных временных
...
[T12 protocol](research/temperature_t12_unified_router_registered.md) ·
[T12 audit](results/research/temperature/t12_unified_router/audit_checks.json) ·
[PDF checkpoint](output/pdf/ivan_continuous_temperature_checkpoint.pdf).
Полный набор после T12: **324 теста**, все прошли.

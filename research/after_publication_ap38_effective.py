"""AP38-E: cadence-guarded weak-regime veto around frozen AP37."""
...
OUT = Path('results/research/after_publication/ap38_effective')
BASE = OUT.parent / 'ap37_effective'
UNKNOWN_H = (3, 5, 10, 20)
CANDIDATE = 'ap26_guarded_core_mature_precision_fallback_cap2'
FROZEN_CONTROLS = (
    AP37_CANDIDATE, AP33_CANDIDATE, AP36_CANDIDATE, AP34_CANDIDATE,
    AP35_CANDIDATE, AP32_CANDIDATE, AP23_BEST, AP26_BEST, AP21_STRICT,
)
...
def main():
    ...
    sources = [
        ...
        *(BASE / name for name in ('metadata.json', 'outputs.npz')),
        Path('research/after_publication_ap38_effective_registered.md'),
    ]

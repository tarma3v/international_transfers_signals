"""AP21-E: separate high-quality primary and cadence experts."""
...
OUT = Path('results/research/after_publication/ap21_effective')
BASE = OUT.parent / 'ap20_effective'
AP12 = OUT.parent / 'ap12_effective'
AP13 = OUT.parent / 'ap13_effective'
AP18 = OUT.parent / 'ap18_effective'
AP19 = OUT.parent / 'ap19_effective'
UNKNOWN_H = (3, 5, 10, 20)
AP20_SELECTED = 'raw_ap18_25_cat75_pace365_p55_r70_month24_cap2'
...
FROZEN_CONTROLS = (
    AP20_SELECTED, AP19_CAT, AP18_CONTROL, AP17_CONTROL, AP12_CONTROL,
    ROLLING_CONTROL, LOCAL_CONTROL, RESERVE_CONTROL, STRICT_CONTROL,
    NEAR_CONTROL, ANCHOR, HAZARD, AP1_CAP,
)


def candidate_key(name):
    return f'{name}_dual_pace_month24_cap2'
...
def main():
    ...
    sources = [DATA, *(folder / name for folder in folders
               ...
               Path('research/after_publication_ap21_effective_registered.md')]
    (OUT / 'metadata.json').write_text(json.dumps({
        'packet': 'AP21-E', 'n_rows': len(panel),

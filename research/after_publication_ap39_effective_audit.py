"""Independent AP39 runway-router and causal precision audit."""
...
from research.after_publication_ap39_effective import (
    BASE,
    CANDIDATE,
    FROZEN_CONTROLS,
    OUT,
...
def main():
    ...
    (OUT / 'audit_checks.json').write_text(json.dumps({
        ...
        'one_week_runway_router_state_and_cap_exact': True,

...
проходит время: окно сделок ЦБ закрывается в 15:30 МСК, курс публикуется обычно
до 18:00 и действует со следующего дня, пуш уходит вечером, а клиент
...
def main() -> None:
    ...
    print("Задержка измеряется в ПУБЛИКАЦИЯХ, а не в календарных днях: курс")
